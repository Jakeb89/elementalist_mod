...
import elementalist_mod.powers.SolarFormPower;
...
public class Solar_Form extends AbstractElementalistCard {
	...
	public static String DESCRIPTION = "The first time you cast an element each turn, gain 2 elementalist:Fire.";
	...
	public void use(com.megacrit.cardcrawl.characters.AbstractPlayer p, AbstractMonster target) {
		...
		AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new SolarFormPower(p, p, 2), 2));

	}

	public AbstractCard makeCopy() {
		return new Solar_Form();
	}
